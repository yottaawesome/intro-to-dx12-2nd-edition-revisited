...
* The code has been ported to C++20 modules (with the exception of the first ), with platform and dependecies exported via modules. This has eliminated the need for separate header and source files, which has improved the code locality and significantly reduced the total LoC.
