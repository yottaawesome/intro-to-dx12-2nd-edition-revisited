...
public:
    ...
    QuatApp(const QuatApp&) = delete;
    auto operator=(const QuatApp&) -> QuatApp& = delete;
...
private:
    ...
    virtual void Update(const GameTimer& gt)override
    {
        ...
        mSkullAnimation.Interpolate(mAnimTimePos, skullWorld);
        ...
        for (int i = 0; i < 3; ++i)
        {
            ...
            lightDir = DirectX::XMVECTOR{ DirectX::XMVector3TransformNormal(lightDir, R) };
    ...
    virtual void Draw(const GameTimer& gt)override
    {
        ...
        auto cmdsLists = { static_cast<D3D12::ID3D12CommandList*>(mCommandList.Get()) };
    ...
    virtual void UpdateImgui(const GameTimer& gt)override
    {
        ...
        if (ImGui::CollapsingHeader("SSAO", ImGui::ImGuiTreeNodeFlags_::ImGuiTreeNodeFlags_DefaultOpen))
        {
    ...
    void DefineSkullAnimation()
    {
        ...
        auto q0 = DirectX::XMVECTOR{DirectX::XMQuaternionRotationAxis(DirectX::XMVectorSet(0.0f, 1.0f, 0.0f, 0.0f), DirectX::XMConvertToRadians(30.0f))};
        auto q1 = DirectX::XMVECTOR{DirectX::XMQuaternionRotationAxis(DirectX::XMVectorSet(1.0f, 1.0f, 2.0f, 0.0f), DirectX::XMConvertToRadians(45.0f))};
        auto q2 = DirectX::XMVECTOR{DirectX::XMQuaternionRotationAxis(DirectX::XMVectorSet(0.0f, 1.0f, 0.0f, 0.0f), DirectX::XMConvertToRadians(-30.0f))};
        auto q3 = DirectX::XMVECTOR{DirectX::XMQuaternionRotationAxis(DirectX::XMVectorSet(1.0f, 0.0f, 0.0f, 0.0f), DirectX::XMConvertToRadians(70.0f))};
    ...
    void BuildRenderItems()
    {
        ...
        texTransform = MathHelper::Identity4x4;
        mSkullRitem = AddRenderItem(RenderLayer::Opaque, worldTransform, texTransform, matLib["skullMat"], mGeometries["skullGeo"].get(), mGeometries["skullGeo"]->DrawArgs["skull"]);
