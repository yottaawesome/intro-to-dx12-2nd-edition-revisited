...
export namespace D3D12
{
	...
	constexpr auto RaytracingShaderRecordByteAlignment = D3D12_RAYTRACING_SHADER_RECORD_BYTE_ALIGNMENT;
	constexpr auto ShaderIdentifierSizeInBytes = D3D12_SHADER_IDENTIFIER_SIZE_IN_BYTES;
