...
PatchTess ConstantHS(InputPatch<VertexOut, 16> patch, uint patchID : SV_PrimitiveID)
{
	...
	pt.EdgeTess[0] = gMiscFloat4.x;
	pt.EdgeTess[1] = gMiscFloat4.x;
	pt.EdgeTess[2] = gMiscFloat4.x;
	pt.EdgeTess[3] = gMiscFloat4.x;
	
	pt.InsideTess[0] = gMiscFloat4.x;
	pt.InsideTess[1] = gMiscFloat4.x;
