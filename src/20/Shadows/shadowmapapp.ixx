...
export class ShadowMapApp : public D3DApp
{
public:
    ShadowMapApp(Win32::HINSTANCE hInstance)
        : D3DApp(hInstance)
    {
    ...
    ShadowMapApp(const ShadowMapApp&) = delete;
    auto operator=(const ShadowMapApp&) -> ShadowMapApp& = delete;
