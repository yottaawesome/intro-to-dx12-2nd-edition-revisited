...
private:
    ...
    void Draw(const GameTimer& gt)override
    {
        ...
        mCommandList->SetGraphicsRootShaderResourceView(GFX_ROOT_ARG::GFX_ROOT_ARG_MATERIAL_SRV, matBuffer->GetGPUVirtualAddress());
    ...
    void BuildRootSignature()
    {
        ...
        gfxRootParameters[GFX_ROOT_ARG::GFX_ROOT_ARG_PASS_CBV].InitAsConstantBufferView(1);
        gfxRootParameters[GFX_ROOT_ARG::GFX_ROOT_ARG_MATERIAL_SRV].InitAsShaderResourceView(0);
    ...
    )
    {
        ...
        ritem->Mat = mat;
        ritem->Geo = geo;
        ritem->PrimitiveType = D3D::D3D_PRIMITIVE_TOPOLOGY::D3D_PRIMITIVE_TOPOLOGY_TRIANGLELIST;
    ...
    auto BuildShapeGeometry(D3D12::ID3D12Device* device, DirectX::ResourceUploadBatch& uploadBatch) -> std::unique_ptr<MeshGeometry>
    {
        ...
        geo->IndexFormat = DXGI::DXGI_FORMAT::DXGI_FORMAT_R16_UINT;
