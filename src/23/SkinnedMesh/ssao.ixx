export module skinnedmesh:ssao;
import std;
import shared;
...
public:
    ...
    void ComputeSsao(D3D12::ID3D12GraphicsCommandList* cmdList, D3D12::ID3D12PipelineState* ssaoPso)
    {
        ...
        transition = D3D12::CD3DX12_RESOURCE_BARRIER::Transition(mAmbientMap0.Get(),
...
private:
    ...
    Microsoft::WRL::ComPtr<D3D12::ID3D12Resource> mNormalMap;
    Microsoft::WRL::ComPtr<D3D12::ID3D12Resource> mAmbientMap0;
    Microsoft::WRL::ComPtr<D3D12::ID3D12Resource> mAmbientMap1;
